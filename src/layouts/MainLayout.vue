...
export default defineComponent({
  ...
  setup() {
    ...
    const filteredOptions = ref<
      Array<INavbarSearchOptions | INavbarSearchFilteredOptions>
    >([]);
    const search = ref(null) as Ref<QSelect | null>; // $refs.search

    const filter: QSelectProps['onFilter'] = (val, update) => {
      if (options.value === null) {
        ...
        //update(); - Expected 1-2 arguments, but got 0
        return;
      }
